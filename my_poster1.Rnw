...
Among 1881 investigated strains, only 62 (3.2\%) had mutations in any repeat of the CsgA motif. The majority (59) of strains had only a single mutation, mostly in S (1). An insignificant fraction had more than 2 mutations. 2 strains (0.1\%) had two mutations, usually in S (1) and G (11) (116 strains). 41 strains had simultaneous mutations in G (4) and A (14).
